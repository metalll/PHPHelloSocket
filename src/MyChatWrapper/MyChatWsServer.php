<?php
namespace Ratchet\MyChatWrapper;
 ...
 */
class MyChatWsServer implements HttpServerInterface {
    ...
    public function __construct(ComponentInterface $component) {
        ...
        echo "My chat wsserver construct \n";
    ...
    public function onClose(ConnectionInterface $conn) {
        if ($this->connections->contains($conn)) {   
            ...
            $wrappedConnection = $context->connection;
            if (!$wrappedConnection->__isset("isCorrectClose")) {
                $wrappedConnection->__set("isCorrectClose", false);
            }
            $this->connections->detach($conn);
            $this->delegate->onClose($wrappedConnection);
        }
    }
    /**
     * {@inheritdoc}
    ...
    public function enableKeepAlive(LoopInterface $loop, $interval = 10) {
